# Generated by Django 2.2.6 on 2019-10-21 06:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('partner', models.ForeignKey(blank=True, default=0, on_delete=django.db.models.deletion.SET_DEFAULT, to='accounts.Partner')),
            ],
        ),
    ]
